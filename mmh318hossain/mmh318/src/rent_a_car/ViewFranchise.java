...
public class ViewFranchise {
    
    
    public ViewFranchise() throws FileNotFoundException, IOException {
        ...
        JLabel reservationslable=new JLabel("           Franhise");
        JLabel l = new JLabel();
...
//        btnpanel.add(Box.createRigidArea(new Dimension(50, 20)));
    ...
    //    Color color1 = new Color(181, 220, 249);
      ...
      //  frame.setLocationRelativeTo(null);
        ...
        Update.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent ae) {
               String fran_id_update= JOptionPane.showInputDialog("Please input Franchise ID:");
            }
        });
        ...
        delete.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent ae) {
               String fran_id_delete= JOptionPane.showInputDialog("Please input Franchise ID:");
            }
        });
    ...
    class PropertyTableModel extends AbstractTableModel {
        ...
        private String[] columnNames = {"Franchise ID", "City", "Location", "Inventory"};
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            switch (columnIndex) {
                ...
                case 3:
                    return list.get(rowIndex).getInventory();
                default:
                    return null;
            }
        }
    ...
    class Property {
        ...
        public void setFranchise_id(String franchiseid) {
